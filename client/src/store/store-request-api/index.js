...
export const createPlaylist = (newUserName, newListName, newSongs, userEmail) => {
...
export const updatePublishPlaylist = (id, playlist) => {
    return api.put(`/playlistPublishP/${id}`, {
        playlist : playlist
    })
}

export const findAllPublishedPlaylistByUser = (userName) => api.get(`/playlistPP/${userName}`);
export const findAllPublishedPlaylistByLists = (list) => api.get(`/playlistPPL/${list}`);
